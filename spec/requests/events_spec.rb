...
describe "Receiving GitHub hooks", :request do
  ...
  describe "POST /events" do
    it "returns a forbidden error to invalid hosts", :vcr do
      github_event("ping")
    ...
    it "returns a unprocessable error for invalid events", :vcr do
    ...
    it "handles ping events from valid hosts", :vcr do
      github_event("ping")
    ...
    it "handles deployment events from valid hosts", :vcr do
    ...
    it "handles deployment status events from valid hosts", :vcr do
